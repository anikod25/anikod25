<h1 align="center">Hey there, I'm Aniket Kodgirwar 👋</h1>

<h3 align="center"><em>"Build it. Break it. Ship it."</em></h3>
...
| 🚀 Project | Stack | About |
|---|---|---|
| 🐳 **ContainerCraft** | React · Vite · Docker | Visual Docker Compose editor with a deep-space UI |
| 🌾 **Agritrace** | AI · Blockchain | Agricultural traceability platform |
| 🔐 **SecureNite** | Browser Extension | Password encryption & security manager |
| 🤖 **Minimax vs RL** | C++ · SFML | Negamax AI vs Q-Learning agent on dual boards |
| 🔑 **Password Auditor** | CrewAI · Gemini | Multi-agent password security analysis tool |
...
<div align="left">
  <img src="https://skillicons.dev/icons?i=cpp,c,python,js,html,css,react,mysql" />
</div>
...
<div align="left">
  <img src="https://skillicons.dev/icons?i=git,github,docker,vscode,latex,vite,figma,linux" />
</div>
